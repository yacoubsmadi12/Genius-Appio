...
import {generateFlutterProjectTemplate} from '@/lib/flutter-template';
...
- Material Design
- Responsive layout
- Complete project structure with Android, iOS, and Web support

## Project Structure

This project includes complete platform folders:
...
You can build and run this app on any supported platform using Flutter.
          ` 
        },
      ];
